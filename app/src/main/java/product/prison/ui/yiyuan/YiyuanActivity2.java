...
public class YiyuanActivity2 extends BaseFram {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_webinfo, container, false);
    ...
    private void setvalue() {
        try {
            details = (Details) getArguments().get("key");
            setdate();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void setdate() {
        try {
            ...
            if (name.equals("航班信息") || name.equals("天气预报")) {
                if (webinfo_line2.getVisibility() == View.VISIBLE) {
                    webinfo_otweb.setVisibility(View.VISIBLE);
                    webinfo_line2.setVisibility(View.GONE);
                }
//                webinfo_otweb.loadUrl(Ini.lvyou.get(name));
            } else {
                ...
                webinfo_web.loadDataWithBaseURL(null, details.getContent(),
