package product.prison.ui.welcome;
...
public class WelcomeActivity extends BaseActivity {
    ...
    private void adDetailAction_getAllAdDetail() {
        ...
        String url = App.requrl("adDetailAction_getAllAdDetail", "");
...
//                            Toast.makeText(getApplicationContext(), json, Toast.LENGTH_LONG).show();
                            LogUtils.d(json);
                            GsonBean<List<WelcomData>> data = App.gson.fromJson(json,
                                    new TypeToken<GsonBean<List<WelcomData>>>() {
                                    }.getType());
                            ...
                            e.printStackTrace();
                            GsonBean<Object> data = App.gson.fromJson(json,
                                    new TypeToken<GsonBean<Object>>() {
                                    }.getType());
                    ...
                    // Volley请求失败时调用的函数
                    @Override
                    public void onMyError(VolleyError e) {
                        e.printStackTrace();
    ...
    private void playmusic() {
        ...
        try {
            mediaPlayer.stop();
            mediaPlayer.reset();
//            Uri uri= Uri.parse(addeList.get(cutad).getBgMusic());
...
//            e.printStackTrace();
    ...
    void tomain() {
//        finish();
        startActivity(new Intent(WelcomeActivity.this, MainActicity.class));
    }
