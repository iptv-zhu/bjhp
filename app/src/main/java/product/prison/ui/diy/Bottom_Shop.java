...
public class Bottom_Shop extends LinearLayout implements View.OnClickListener {
    View view;
    Context context;
    App app;

    public Bottom_Shop(Context context, AttributeSet attrs) {
        super(context, attrs);
        view = LayoutInflater.from(context).inflate(R.layout.bottom_shop, this);
