...
public class Bottom164 extends LinearLayout implements View.OnClickListener {
    View view;
    Context context;
    App app;

    public Bottom164(Context context, AttributeSet attrs) {
        super(context, attrs);
        view = LayoutInflater.from(context).inflate(R.layout.bottom164, this);
