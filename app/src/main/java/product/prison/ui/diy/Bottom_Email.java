...
public class Bottom_Email extends LinearLayout implements View.OnClickListener {
    View view;
    Context context;
    App app;

    public Bottom_Email(Context context, AttributeSet attrs) {
        super(context, attrs);
        view = LayoutInflater.from(context).inflate(R.layout.bottom_email, this);
